...
CREATE TABLE PRIZES(
    ...
    CONSTRAINT c_prize_fk_contest_id FOREIGN KEY(contest_id) REFERENCES CONTESTS(id) ON DELETE CASCADE,
...
CREATE TABLE SUBMISSIONS(
    ...
    CONSTRAINT c_subm_fk_contest_id FOREIGN KEY(contest_id) REFERENCES CONTESTS(id) ON DELETE CASCADE,
    CONSTRAINT c_subm_fk_contestant_id FOREIGN KEY(contestant_id) REFERENCES CONTESTANTS(id) ON DELETE CASCADE,
    ...
    CONSTRAINT c_subm_valid_score CHECK(0 <= score and score <= 1)
);
