...
class Prize:
    ...
    def get_lowercase_columns() -> list[str]:
        return ["contest_id", "prize_id", "initial_qty", "remaining_qty", "description", "estimated_value", "photo_data"]
    ...
    def from_full_tuple(self, tuple):
        ...
        self.photo_data = None if tuple[6] is None else tuple[6]
        return self

    def as_dict(self):
        return {"contest_id": self.contest_id, "prize_id": self.prize_id, "initial_qty": self.initial_qty, "remaining_qty": self.remaining_qty, "description": self.description, "estimated_value": self.estimated_value, "photo_data": self.photo_data}
